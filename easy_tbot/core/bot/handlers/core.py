...
class InlineHandler(AbstractHandler, ABC):
    ...
    @final
    def setup(self, bot):
        bot.add_inline_handler(self) # check that this object(self) is the proper handler
...
class ChosenInlineHandler(AbstractHandler, ABC):
    ...
    @final
    def setup(self, bot):
        bot.add_chosen_inline_handler(self) # check that this object(slef) is the proper handler
